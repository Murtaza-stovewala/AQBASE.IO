...
const services = [
  {
    icon: <dotlottie-wc src="https://lottie.host/5d5c1285-7341-4651-9c7e-34a629494e01/sXHKLFOcz0.lottie" style={{ width: '100%', height: '160px' }} speed="1" autoplay loop className="mb-4 transition-transform duration-500 group-hover:scale-110"></dotlottie-wc>,
    title: "Web Design & Development",
    description: "Building modern, fast & responsive websites tailored for your needs.",
    delay: "0",
  },
  {
    icon: <dotlottie-wc src="https://lottie.host/04c17c12-730b-421d-9f5e-294953267d00/TR5fGKv6bI.lottie" style={{ width: '100%', height: '160px' }} speed="1" autoplay loop className="mb-4 transition-transform duration-500 group-hover:scale-110"></dotlottie-wc>,
  ...
  {
    icon: <dotlottie-wc src="https://lottie.host/01902b79-fc2a-4068-ba08-6dd5c44e39f6/lkURLJTqG6.lottie" style={{ width: '100%', height: '160px' }} speed="1" autoplay loop className="mb-4 transition-transform duration-500 group-hover:scale-110"></dotlottie-wc>,
